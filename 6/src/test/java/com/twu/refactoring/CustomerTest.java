...
public class CustomerTest {
    ...
    public void shouldOutputChangedStatement() throws Exception {
        disable.removeRental(laRental);
        disable.addRental(new Rental(new RegularMovie("LA Confidential"),2));
